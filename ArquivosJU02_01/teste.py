...
def configurar_fundo(frame):
    imagem = Image.open(r"C:\Users\ohana\OneDrive\Área de Trabalho\UFMG\4° PERIODO\POO\trabalho final\POO\ArquivosJU02_01\tpos.jpeg")
...
def Tela_Inicial(root):
    ...
    imagem = Image.open(r"C:\Users\ohana\OneDrive\Área de Trabalho\UFMG\4° PERIODO\POO\trabalho final\POO\ArquivosJU02_01\tinicial.jpeg")
    imagem = imagem.resize((800, 600), Image.Resampling.LANCZOS)
    bg = ImageTk.PhotoImage(imagem)
...
def Tela_CadastroAlimento(root, refeicao):
    ...
    # Lendo o CSV
    lista_alimentos = ler_csv(r"C:\Users\ohana\OneDrive\Área de Trabalho\UFMG\4° PERIODO\POO\trabalho final\POO\ArquivosJU02_01\TACO.csv")
